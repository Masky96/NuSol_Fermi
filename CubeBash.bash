...
for particleName in  "e-" "proton"  
do
    #For Particle energies in MeV*10^-1
    for EnergyValue in 800 900 1000 1500 2000 2500 3000 3500 4000 4500 5000
    do

	for Rotation in 0  225 450 675 900
	do
	    
	    
	    #Define the Directory for the doings
	    directory=''$EnergyValue' MeV '$particleName'Root Data'
...
/gun/position 0 0 -30 cm
	       ...
	       #Creating Histograms
/analysis/setFileName "$particleName+$EnergyValue+$Rotation"
...
' > CSatMainVolume.cc
		       ...
		       mv CSatMainVolume.cc ~/Desktop/CubeSat/src
		       make
	    ...
	    #Don't know exactly why
		       ...
		       mv $particleName+$EnergyValue+$Rotation.root "$directory"
