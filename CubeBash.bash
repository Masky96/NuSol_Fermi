...
do
	...
	do
	    ...
	    directory='Histogram for Particles from '$EnergyValue'E-1 MeV Neutrinos'
...
void CSatPrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  */
  ...
  //fparticleGun->GeneratePrimaryVertex(anEvent);
    ...
    G4int gammaprocess = '$gammaProcess';  // 69Ge:  0 for ground state, 1 for 87 keV gamma, 2 for 397 keV gamma
...
void CSatPrimaryGeneratorAction::SetOptPhotonPolar(G4double angle)
{
  ...
  particleGun->SetParticlePolarization(polar);
	    ...
	    mv $particleName+$EnergyValue+$gammaProcess.root "$directory"
