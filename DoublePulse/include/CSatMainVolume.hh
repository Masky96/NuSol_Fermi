...
//
//
/// \file optical/CSat/include/CSatMainVolume.hh
/// \brief Definition of the CSatMainVolume class
//
#ifndef CSatMainVolume_h
#define CSatMainVolume_h 1
...
class CSatMainVolume : public G4PVPlacement
{
 public:
  CSatMainVolume(G4RotationMatrix* pRot, const G4ThreeVector& tlate,
                G4LogicalVolume* pMotherLogical, G4bool pMany, G4int pCopyNo,
                CSatDetectorConstruction* c);
  ...
  G4LogicalVolume* GetLogPhotocathG() { return fPhotocathG_log; }
  
  G4LogicalVolume* GetLogScint() { return fScint_log; }
  G4LogicalVolume* GetLogVeto() { return fVeto_Log; }
  ...
  */
  ...
  CSatDetectorConstruction* fConstructor;
  /*
  G4double fScint_x;
  G4double fScint_y;
  G4double fScint_z;
  */
  ...
  G4LogicalVolume* fPmt_GAGGlog;
  G4LogicalVolume* fair_log;
  G4LogicalVolume* fIron_log;
  G4LogicalVolume* fAirGap_log;
  G4LogicalVolume* falumGAGG_log;
