...
//
//
/// \file optical/CSat/src/CSatUserTrackInformation.cc
/// \brief Implementation of the CSatUserTrackInformation class
//
//
...
CSatUserTrackInformation::CSatUserTrackInformation()
  : fStatus(active)
  , fReflections(0)
  , fForcedraw(false)
{}
...
void CSatUserTrackInformation::AddTrackStatusFlag(int s)
{
