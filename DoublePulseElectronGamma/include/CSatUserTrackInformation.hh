...
//
//
/// \file optical/CSat/include/CSatUserTrackInformation.hh
/// \brief Definition of the CSatUserTrackInformation class
//
#include "G4VUserTrackInformation.hh"
#include "globals.hh"

#ifndef CSatUserTrackInformation_h
#  define CSatUserTrackInformation_h 1

enum CSatTrackStatus
{
  active           = 1,
  hitPMT           = 2,
  absorbed         = 4,
...
class CSatUserTrackInformation : public G4VUserTrackInformation
{
 public:
  CSatUserTrackInformation();
  ~CSatUserTrackInformation();
