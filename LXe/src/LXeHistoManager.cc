...
void LXeHistoManager::Book()
{
  ...
  //3
  // analysisManager->CreateH1("edep", "Energy Deposition in the PMT", nbins, vmin, vmax);
  analysisManager->CreateH1("Wavelength","Range of the Wavelengths in the PMT",nbins, vmin, vmax);
